    ...
    <div class="px-5 py-4 border-b border-gray-100">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            ...
            <div class="flex items-center gap-3 flex-1 sm:flex-initial">
                ...
                {{-- Export --}}
                <a href="{{ route('admin.users.export', request()->only(['search', 'role', 'status', 'date_from', 'date_to'])) }}" class="hidden sm:inline-flex items-center gap-2 px-4 py-2 text-sm text-gray-600 border border-gray-200 rounded-lg hover:bg-gray-50 transition">
...
<div id="createDrawer" class="fixed top-0 right-0 z-[70] h-full w-full sm:w-[480px] translate-x-full transition-transform duration-300 ease-out flex flex-col bg-white shadow-2xl">
    ...
    <div class="px-6 py-4 border-t border-gray-100 bg-gray-50/80 flex gap-3">
        ...
        <button onclick="submitCreate(this, 'createUserForm', 'Creando...')" type="button" class="flex-1 px-4 py-2.5 text-sm bg-indigo-500 text-white rounded-xl hover:bg-indigo-600 transition font-medium shadow-sm shadow-indigo-200">
