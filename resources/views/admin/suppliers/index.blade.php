...
@php
    ...
    $filterCount = collect(['status','city'])->filter(fn($f) => request($f) !== null && request($f) !== '')->count();
@endphp
    ...
    <div class="filter-panel">
        ...
        <div class="p-4">
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-3">
                ...
                <div class="filter-field">
                    <label>Ciudad</label>
                    <select id="filter_city" onchange="applyFilters()">
                ...
                <div class="flex items-end col-span-2 lg:col-span-2">
                    @if($hasFilters)
                    <a href="{{ route('admin.suppliers.index') }}" class="inline-flex items-center gap-2 px-4 py-2 text-xs font-semibold text-red-500 hover:text-red-600 hover:bg-red-50 rounded-lg transition">
    ...
    <div class="px-5 py-4 border-b border-gray-100">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            ...
            <div class="flex items-center gap-3 flex-1 sm:flex-initial">
                ...
                <a href="{{ route('admin.suppliers.export', request()->only(['search'])) }}" class="hidden sm:inline-flex items-center gap-2 px-4 py-2 text-sm text-gray-600 border border-gray-200 rounded-lg hover:bg-gray-50 transition">
    ...
    <div class="px-5 py-3.5 border-t border-gray-100">
        <div class="flex flex-col sm:flex-row items-center justify-between gap-3">
            ...
            <nav class="flex items-center gap-1">
                ...
                <a href="{{ $suppliers->url(1) }}" class="w-8 h-8 flex items-center justify-center rounded-md text-gray-500 hover:bg-gray-100 transition text-xs" title="Primera" aria-label="Primera página">
                ...
                @else
                <a href="{{ $suppliers->previousPageUrl() }}" class="w-8 h-8 flex items-center justify-center rounded-md text-gray-500 hover:bg-gray-100 transition text-xs" aria-label="Página anterior"><i class="fas fa-chevron-left"></i></a>
                @endif
                @php
                ...
                <a href="{{ $suppliers->nextPageUrl() }}" class="w-8 h-8 flex items-center justify-center rounded-md text-gray-500 hover:bg-gray-100 transition text-xs" aria-label="Página siguiente"><i class="fas fa-chevron-right"></i></a>
                @else
                ...
                <a href="{{ $suppliers->url($last) }}" class="w-8 h-8 flex items-center justify-center rounded-md text-gray-500 hover:bg-gray-100 transition text-xs" title="Última" aria-label="Última página">
...
<div id="createDrawer" class="fixed top-0 right-0 z-[70] h-full w-full sm:w-[500px] translate-x-full transition-transform duration-300 ease-out flex flex-col bg-white shadow-2xl">
    ...
    <div class="px-6 py-4 border-t border-gray-100 bg-gray-50/80 flex gap-3">
        ...
        <button onclick="submitCreate(this, 'createSupplierForm', 'Creando...')" type="button" class="flex-1 px-4 py-2.5 text-sm bg-indigo-500 text-white rounded-xl hover:bg-indigo-600 transition font-medium shadow-sm shadow-indigo-200">
