...
@php
    ...
    $filterCount = collect(['status'])->filter(fn($f) => request($f))->count();
@endphp
            ...
            <form method="GET" id="filterForm">
                ...
                <div class="grid grid-cols-2 lg:grid-cols-4 gap-3">
                    ...
                    <div class="flex items-end">
                        @if($hasFilters)
                        <a href="{{ route('admin.contact-messages.index') }}" class="inline-flex items-center gap-2 px-4 py-2 text-xs font-semibold text-red-500 hover:text-red-600 hover:bg-red-50 rounded-lg transition">
