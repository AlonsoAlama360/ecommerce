                ...
                <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="max-width: 600px; width: 100%;">
                                        ...
                                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                                            <tr>
                                                ...
                                                <td style="padding-left: 14px;">
                                                    <p style="margin: 0 0 3px; color: #333; font-weight: 700; font-size: 14px;">Regalos con amor</p>
                                                    <p style="margin: 0; color: #888; font-size: 13px; line-height: 1.5;">Productos seleccionados con cuidado para cada ocasi&oacute;n especial.</p>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                    ...
                                    <td style="background-color: #FDF9F5; border-radius: 12px; padding: 20px; border-left: 4px solid #C39563;">
                                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                                            <tr>
                                                ...
                                                <td style="padding-left: 14px;">
                                                    <p style="margin: 0 0 3px; color: #333; font-weight: 700; font-size: 14px;">Ofertas exclusivas</p>
                                                    <p style="margin: 0; color: #888; font-size: 13px; line-height: 1.5;">Accede a descuentos y promociones especiales solo para miembros.</p>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                    ...
                                    <td style="background-color: #FDF9F5; border-radius: 12px; padding: 20px; border-left: 4px solid #B8864F;">
                                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                                            <tr>
                                                ...
                                                <td style="padding-left: 14px;">
                                                    <p style="margin: 0 0 3px; color: #333; font-weight: 700; font-size: 14px;">Env&iacute;os seguros</p>
                                                    <p style="margin: 0; color: #888; font-size: 13px; line-height: 1.5;">Seguimiento en tiempo real de todos tus pedidos desde tu perfil.</p>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                    ...
                    <tr>
                        <td style="background-color: #FFFFFF; padding: 25px 40px 35px; text-align: center;">
                                ...
                                <tr>
                                    <td style="border-radius: 12px; background-color: #D4A574;">
                                        <a href="{{ url('/') }}"
                                            ...
                                            <span style="mso-text-raise: 11pt;">Explorar Tienda</span>
                            ...
                            <p style="margin: 18px 0 0; color: #AAAAAA; font-size: 12px;">
                                O copia este enlace: <a href="{{ url('/') }}" style="color: #C39563;">{{ url('/') }}</a>
                            </p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="background-color: #FFFFFF; padding: 25px 40px 30px;">
                            <p style="margin: 0 0 12px; color: #999; font-size: 12px; font-weight: 600; text-transform: uppercase; letter-spacing: 1px;">Tu cuenta</p>
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td style="padding: 8px 0; border-bottom: 1px solid #F0ECE7;">
                                        <span style="color: #999; font-size: 13px;">Nombre</span>
                                    </td>
                                    <td style="padding: 8px 0; border-bottom: 1px solid #F0ECE7; text-align: right;">
                                        <span style="color: #333; font-size: 13px; font-weight: 600;">{{ $user->first_name }} {{ $user->last_name }}</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding: 8px 0;">
                                        <span style="color: #999; font-size: 13px;">Email</span>
                                    </td>
                                    <td style="padding: 8px 0; text-align: right;">
                                        <span style="color: #333; font-size: 13px; font-weight: 600;">{{ $user->email }}</span>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td style="background-color: #F9F5F0; border-radius: 0 0 20px 20px; padding: 28px 40px; text-align: center;">
                            ...
                            <p style="margin: 0; color: #BBBBBB; font-size: 11px; line-height: 1.5;">
                                Recibiste este correo porque creaste una cuenta en nuestra tienda.<br>
