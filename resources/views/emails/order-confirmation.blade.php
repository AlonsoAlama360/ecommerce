...
<body style="margin: 0; padding: 0; background-color: #F5F1EC; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; -webkit-font-smoothing: antialiased;">
    ...
    <div style="display: none; max-height: 0; overflow: hidden; mso-hide: all;">
        Pedido {{ $order->order_number }} confirmado &nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;
    </div>
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td style="padding: 40px 40px 24px;">
                                        <p style="margin: 0 0 6px; color: #C39563; font-size: 13px; font-weight: 600; text-transform: uppercase; letter-spacing: 1.5px;">Pedido confirmado</p>
                                        <h1 style="margin: 0 0 8px; color: #1A1A1A; font-size: 22px; font-weight: 700;">Gracias por tu compra, {{ explode(' ', $order->customer_name)[0] }}</h1>
                                        <p style="margin: 0; color: #888; font-size: 14px; line-height: 1.5;">Tu pedido <strong style="color: #333;">{{ $order->order_number }}</strong> est&aacute; siendo procesado.</p>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td style="padding: 8px 40px 28px;">
                                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="border-top: 1px dashed #E5E0DA; padding-top: 14px;">
                                            ...
                                            <tr>
                                                <td style="padding: 3px 0; color: #888; font-size: 13px;">Env&iacute;o</td>
                                                <td style="padding: 3px 0; color: #333; font-size: 13px; text-align: right;">S/ {{ number_format($order->shipping_cost, 2) }}</td>
                                            </tr>
                                            @endif
                                            <tr>
                                        ...
                                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td width="50%" style="vertical-align: top; padding-right: 12px;">
                                                    <p style="margin: 0 0 4px; color: #AAA; font-size: 11px; font-weight: 600; text-transform: uppercase; letter-spacing: 1px;">Pago</p>
                                                    <p style="margin: 0; color: #333; font-size: 13px; font-weight: 600;">{{ $order->payment_method_label }}</p>
                                                </td>
